...
L'AIC du modèle estimé vaut $900.88$. Les critères d'information AIC, AICc et BICf fournis dans le *summary* sont tous proches de $900$.
...
Nous effectuons *a posteriori* des hypothèses sur le bruit. Nous testons si les résidus estimés sont bien cohérent avec l'hypothèse de bruit blanc du modèle. Pour cela nous effectuons des tests du Portemanteau pour différents retards.
...
Comme la p-value du test de Shapiro est supérieure à $5\%$ alors on ne rejette pas l'hypothèse de normalité des résidus. Ce test ne contredit pas l'hypothèse de normalité. Et donc, l'estimation du modèle SARIMA obtenu par maximum de vraisemblance n'est pas ***********
